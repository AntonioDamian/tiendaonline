...
namespace ApiTienda.Controllers
{
    ...
    public class LinpedsController : ControllerBase
    {
        ...
        // GET: api/Linpeds/5
        [HttpGet("{id}")]
        public async Task<IActionResult> GetLinped([FromRoute] int id)
        {
        ...
        public async Task<IActionResult> GetLinped([FromRoute] int id, int id_linea)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        public async Task<IActionResult> DeleteLinped([FromRoute] int id, int id_linea)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
